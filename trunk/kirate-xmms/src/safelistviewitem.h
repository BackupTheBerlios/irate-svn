...
#define IR_DOWNLOAD_COL 7
/**
@author Matthias Studer
*/
class SafeListViewItem: public KListViewItem{
	public:
		SafeListViewItem(QListView *parent, QTrack* mtrack);
//		SafeListViewItem(SafeListViewItem *i);
		...
		virtual void reDownload();
		//virtual QString file() const;
		int compare(QListViewItem * i, int col, bool ascending) const;
		virtual void remove();
		virtual void setHeaders();
		virtual bool operator==(const SafeListViewItem &d)const;
